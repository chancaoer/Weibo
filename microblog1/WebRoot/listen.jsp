...
<html>
	...
	function changeQuxiao(follow_id, user_id) {
		xmlHttp = getXmlHttp();
		if (xmlHttp == null) {
			alert("亲，你的浏览器不支持AJAX");
			return;
		} else {
			var url = "/microblog/reldelete.action?follow_id=" + follow_id
					+ "&user_id=" + user_id;
	...
	function stateChanged(quxiaoImgId) {
		var noListen = document.getElementById("noListen_" + quxiaoImgId);

		var quxiaoImg = document.getElementById("quxiao_" + quxiaoImgId);

		quxiaoImg.style.display = "none";
		noListen.style.display = "";
			...
			<div id="page">
				<div id="page-bgtop">
					<div id="page-bgbtm">
						<div id="content">
							<table width="90%">
								<s:iterator value="#session.usersFollows">
									<tr>
										<td>
										...
										<td>
											<span id="quxiao_<s:property value="id"/>"> <img
													src="images/yishouting.jpg"> <a
												href="javascript:void(0)"
												onclick="changeQuxiao('<s:property value="id"/>','<s:property value="#session.user.id" />')">取消</a>
											</span>
											...
											<span id="noListen_<s:property value="id"/>"
												style="display: none;"> <img alt=""
													src="images/shouting.jpg"> </span>
										</td>
									</tr>
									<tr>
										<td colspan="3">
